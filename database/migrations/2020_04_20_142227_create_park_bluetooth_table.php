...
class CreateParkBluetoothTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('park_bluetooth', function (Blueprint $table) {
            $table->id();
            $table->string('name', 50)->comment('蓝牙名称');
    ...
    {
        Schema::dropIfExists('park_bluetooth');
    }
}
