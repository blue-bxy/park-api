...
@section('content')
    ...
    <div class="float">
        <div class="float_flex">
            ...
            <form class="layui-form" action="{{ route('admin.carapt.index') }}" method="GET" id="searchForm">
                <!-- 地区选择 -->
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">项目</label>
                        <div class="layui-input-inline">
                            <input name="park_id" class="layui-input" type="text" placeholder="请输入项目名称" autocomplete="off" lay-verify="required">
                        </div>
                    </div>
                    <div class="layui-inline">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label long-size">订单查询</label>
                        <div class="layui-input-inline">
                            <input value="" name="" class="layui-input" id="" type="text" placeholder="订单号">
                        </div>
                    </div>
                    <div class="layui-inline">
...
{{--                    <a href="{{ route('admin.carapt.create') }}">导出报表</a>--}}
...
@section('scripts')
    ...
    <script>
        ...
        // 将选中的select固定，除非重新选择
        {{--var provinceVal = "<?php echo isset($_GET['park_province']) ? $_GET['park_province']: ''; ?>";--}}
        {{--var cityVal = "<?php echo isset($_GET['park_city']) ? $_GET['park_city']: ''; ?>";--}}
        {{--var districtVal = "<?php echo isset($_GET['park_area']) ? $_GET['park_area']: ''; ?>";--}}
        // layui
