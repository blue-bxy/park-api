        ...
        <div class="float_flex">
            ...
            <div class="float_table_es">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    @foreach($parkCameras as $camera)
                        <tr>
                            <td>{{ $camera->park->park_name }}</td>
                            <td>{{ $camera->area->name }}</td>
                            <td>{{ $camera->id }}</td>
                            <td></td>
                            <td>{{ $camera->brand }}</td>
                            <td>{{ $camera->model }}</td>
                            <td>{{ $camera->network_status }}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                <div class="ination ">
                    {{ $parkCameras->withQueryString()->links() }}
                </div>
            </div>
        </div>
    </div>
